...
/* **********************************************
 * require["./browser"] uses several features of the javascript language,
 * which Firefox deems to be unsafe for use within its add-ons.
 *
 * specifically:
 *  - eval( untrusted_code )
 ...
 *
 * observations:
 *  - the global variable "CoffeeScript" is assigned to: require["./coffee-script"]
 *  - require["./browser"] does not appear to be reachable through invokation of this function.
 *  - it appears to be a helper function:
 *      * attaches an event listener to window.onload
 *      * searches the DOM for <script> tags having: type="text/coffeescript"
 *      * foreach: extracts the content, converts it to javascript, evaluates the javascript
 *
 * conclusions:
 * - this helper functionality isn't needed by a Firefox add-on;
 *   require["./browser"] can safely be removed.
 * ********************************************** */
/*
		require["./browser"] = function() {
			...
			return function() {
				...
				CoffeeScript = require("./coffee-script"), CoffeeScript.require = require, compile = CoffeeScript.compile, CoffeeScript.eval = function(code, options) {
					...
					var r;
					return null == n && (n = {}), null == i && (i = !1), n.sourceFiles = [e], r = window.ActiveXObject ? new window.ActiveXObject("Microsoft.XMLHTTP") : new window.XMLHttpRequest, r.open("GET", e, !0), "overrideMimeType" in r && r.overrideMimeType("text/plain"), r.addEventListener("onreadystatechange", function() {
						var s, o;
						if (4 === r.readyState) {
